            ...
            <div class="container ">
                ...
                <div class="col-md-10 main-section">
                    <section>
                        ...
                        <form method="post" action="{{ url('categorysearch') }}">
                            {{ csrf_field() }}
                            <table class="table1">
                        ...
                        <p style="padding-top:20px">category 1 of 2, showing 10 records out of 13 total, starting on
                            record
                            1, ending on 10</p>
                        <table class="table2">
                            <thead>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td><a href="{{ 'category_delete/' . $data->id }}">Delete</a></td>
                                        <td><a href="{{ 'categoryadd/' . $data->id }}">Edit</a></td>
                                    </tr>
                                    <?php
                                    $count++;
                                    ?>
